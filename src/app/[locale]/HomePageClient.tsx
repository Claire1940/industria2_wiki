...
export default function HomePageClient({
  ...
  const officialLinks = externalLinks
    ...
    '@graph': [
      {
        ...
        '@id': `${siteUrl}/#website`,
        url: siteUrl,
        name: "INDUSTRIA 2 Wiki",
        description: "Complete INDUSTRIA 2 Wiki covering release date, trailer, story, walkthroughs, weapons, enemies, achievements, and support resources.",
        image: {
          '@type': 'ImageObject',
          url: `${siteUrl}/images/hero.webp`,
          width: 1920,
          height: 1080,
          caption: "INDUSTRIA 2 Official Launch Artwork",
        },
        potentialAction: {
          '@type': 'SearchAction',
      ...
      },
      {
        ...
        name: "INDUSTRIA 2 Wiki",
        alternateName: "INDUSTRIA 2",
        url: siteUrl,
        description: "Fan-made INDUSTRIA 2 resource hub for release information, guides, walkthroughs, and community links.",
        logo: {
          '@type': 'ImageObject',
        ...
        sameAs: [
          officialLinks.officialSite,
          officialLinks.developerSite,
          officialLinks.steamStore,
          officialLinks.steamCommunity,
      ...
      },
      {
        ...
        genre: ['Narrative FPS', 'Sci-Fi', 'Single-player', 'Horror'],
        numberOfPlayers: {
          minValue: 1,
          maxValue: 1,
        },
    ...
    <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="scroll-reveal grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {t.modules.lucidBlocksCreaturesAndEnemies.creatures.map((c: any, index: number) => (
              <div key={index} className="p-6 bg-white/5 border border-border rounded-xl hover:border-[hsl(var(--nav-theme)/0.5)] transition-colors">
                <div className="mb-3">
                  <span className={`text-xs px-2 py-1 rounded-full border ${["Hostile Enemy","Major Threat","Elite Threat"].includes(c.role) ? "bg-[hsl(var(--nav-theme-light)/0.15)] border-[hsl(var(--nav-theme-light)/0.45)] text-[hsl(var(--nav-theme-light))]" : "bg-[hsl(var(--nav-theme)/0.1)] border-[hsl(var(--nav-theme)/0.3)]"}`}>{c.role}</span>
                </div>
                <h3 className="font-bold mb-2">
            ...
            {t.modules.lucidBlocksBestEarlyUnlocks.priorities.map((p: any, index: number) => (
              <div key={index} className="p-6 bg-white/5 border border-border rounded-xl hover:border-[hsl(var(--nav-theme)/0.5)] transition-colors">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className={`text-xs px-2 py-1 rounded-full border ${p.priority === "Essential" ? "bg-[hsl(var(--nav-theme-light)/0.15)] border-[hsl(var(--nav-theme-light)/0.45)] text-[hsl(var(--nav-theme-light))]" : p.priority === "Very High" ? "bg-[hsl(var(--nav-theme)/0.2)] border-[hsl(var(--nav-theme)/0.45)] text-[hsl(var(--nav-theme-light))]" : "bg-[hsl(var(--nav-theme)/0.1)] border-[hsl(var(--nav-theme)/0.3)]"}`}>{p.priority}</span>
                </div>
                <h3 className="font-bold mb-2">
      ...
      <section id="crash-fix" className="scroll-mt-24 px-4 py-20 bg-white/[0.02]">
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="scroll-reveal p-6 bg-[hsl(var(--nav-theme-light)/0.12)] border border-[hsl(var(--nav-theme-light)/0.35)] rounded-xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <a
                    href={officialLinks.steamCommunity}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-muted-foreground hover:text-[hsl(var(--nav-theme-light))] transition"
                  >

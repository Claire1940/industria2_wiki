...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
	...
	return {
		title: {
			default: 'INDUSTRIA 2 Wiki',
			template: '%s | INDUSTRIA 2 Wiki',
		},
		description:
			'INDUSTRIA 2 Wiki provides release info, trailer links, walkthroughs, story guides, weapons, enemies, achievements, and platform support.',
		robots: {
			index: true,
			follow: true,
			googleBot: {
